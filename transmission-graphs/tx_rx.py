...
class tx_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, baud=9600):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "tx_rx")
        ...
        self.freq_deviation = freq_deviation = (mod_index * baud) / 2
    ...
    def set_baud(self, baud):
        self.baud = baud
        self.set_freq_deviation((self.mod_index * self.baud) / 2)
...
def argument_parser():
    ...
    parser.add_argument(
        "--baud", dest="baud", type=eng_float, default=eng_notation.num_to_str(float(9600)),
...
def main(top_block_cls=tx_rx, options=None):
    ...
    tb = top_block_cls(baud=options.baud)
